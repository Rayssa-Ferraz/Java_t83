...
| ------- | ---------------------- | ------------------------------------------------------------ | ----------------------------------------------------- |
| Aula 01 | Introdução ao Java     | [Abrir](https://github.com/Rayssa-Ferraz/Java_t83/tree/main/helloworld | Primeiros passos, estrutura básica e saída de dados   |
| Aula 02 | Variáveis e Operadores | [Abrir](https://github.com/Rayssa-Ferraz/Java_t83/tree/main/operadores/src/operadores) | Variáveis, constantes, `Scanner`, operadores diversos |
| Aula 03 | Condicionais e Lógicos | [Abrir](https://github.com/Rayssa-Ferraz/Java_t83/tree/main/condicionais) | `if/else`, `switch`, operadores relacionais e lógicos |
| Aula 04 | Laços de Repetição     | [Abrir](https://github.com/Rayssa-Ferraz/Java_t83/tree/main/repeticoes | Estruturas `for`, `while` e `do-while`                |
| Aula 05 | Arrays                 | [Abrir](https://github.com/Rayssa-Ferraz/Java_t83/tree/main/vetores | Vetores e matrizes                                    |
| Aula 06 | Collections (Parte 1)  | [Abrir](https://github.com/Rayssa-Ferraz/Java_t83/tree/main/colecoes) | Trabalhando com `ArrayList` e `Set`                   |
| Aula 07 | Collections (Parte 2)  | [Abrir](https://github.com/Rayssa-Ferraz/Java_t83/tree/main/colecoes) | Uso de `Queue` e `Stack`                              |
| Aula 08 | Métodos                | [Abrir](https://github.com/Rayssa-Ferraz/Java_t83/tree/main/metodos | Criação de métodos com e sem retorno                  |
...
1. Clone o repositório [Aulas Java](https://github.com/Rayssa-Ferraz/Java_t83) dentro da pasta do *Workspace* do Eclipse/STS

```bash
git clone https://github.com/Rayssa-Ferraz/Java_t83.git
```
