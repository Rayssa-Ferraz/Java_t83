...
public class Unario {
	...
	public static void main(String[] args) {
		...
		System.out.printf("Após incrementar a variavel original: resultado = %d, Valor Atualizado = %d%n", preIncrementoResultado, preIncrementoOriginal);
		
		System.out.println();
		
		System.out.printf("Pós Incremento: valor original = %d%n", posIncrementoOriginal);
		posIncrementoResultado = posIncrementoOriginal++;
		System.out.printf("Após incrementar a variavel original: resultado = %d, Valor Atualizado = %d%n", posIncrementoResultado, posIncrementoOriginal);
